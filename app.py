...
try:
    ...
    <div class="footer">
        <div class="footer-content">
            <div class="footer-avatar" style="display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #6366f1, #8b5cf6); font-size: 32px; font-weight: 700; color: white;">
                SK
            </div>
            <div class="footer-text">
                <div class="footer-name">Samarth Kumar Samal</div>
